 <nav class="backdrop-blur-[1px] shadow-lg outline-none fixed w-full z-20 top-0 start-0 border-b text-gray-300">
        <div class="max-w-6xl flex flex-wrap items-center justify-between mx-auto py-1 px-4">
            ...
            <button id="menu-btn" data-collapse-toggle="navbar-default" type="button"
            ...
            <div class="hidden  transition-all duration-5000 ease-in-out w-full md:block md:w-auto" id="navbar-default">
                <ul
                    class="font-medium flex flex-col  md:p-0 mt-2  border rounded-md bg-indigo-900 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-transparent">
                    <li>
                        <a href="#"
                            class="block py-2 px-3 text-white rounded md:bg-transparent md:text-fg-brand md:p-0"
